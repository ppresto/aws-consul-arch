data "kubectl_path_documents" "web" {
  pattern = "${path.module}/templates/${var.service_template}/release-web/*.yaml"
}
data "kubectl_path_documents" "apiv2" {
  pattern = "${path.module}/templates/${var.service_template}/release-apiv2/*.yaml"
}
...
data "kubectl_path_documents" "apiv3" {
  pattern = "${path.module}/templates/${var.service_template}/release-apiv3/api-v3.yaml"
}
