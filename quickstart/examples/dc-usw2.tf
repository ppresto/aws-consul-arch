...
module "eks-usw2" {
  ...
  # cluster_additional_security_group_ids = [module.sg-consul-dataplane-usw2[each.key].securitygroup_id]
  # node_security_group_id                = module.sg-consul-dataplane-usw2[each.key].securitygroup_id
